...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  section: { backgroundColor: colors.card, borderRadius: 16, padding: 20, marginBottom: 16 },
  ...
  dangerSection: { borderWidth: 1, borderColor: colors.danger + '40' },
  dangerText: { fontSize: 14, color: colors.textMuted, lineHeight: 20, marginBottom: 8 },
  deleteBtn: { backgroundColor: colors.danger, borderRadius: 12, padding: 14, alignItems: 'center', marginTop: 16, flexDirection: 'row', justifyContent: 'center', gap: 8 },
