...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  statBox: { flex: 1, backgroundColor: colors.card, borderRadius: 12, padding: 12, alignItems: 'center' },
  statNum: { fontSize: 24, fontWeight: 'bold', color: colors.text },
  statLabel: { fontSize: 11, color: colors.textMuted, marginTop: 4 },
  empty: { alignItems: 'center', padding: 60 },
  emptyText: { color: colors.textMuted, fontSize: 16 },
  teamCard: { backgroundColor: colors.card, borderRadius: 12, flexDirection: 'row', alignItems: 'center', marginBottom: 8, overflow: 'hidden' },
