...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  channelCard: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: colors.border },
  ...
  label: { fontSize: 14, color: colors.textMuted, marginBottom: 8, marginTop: 12 },
