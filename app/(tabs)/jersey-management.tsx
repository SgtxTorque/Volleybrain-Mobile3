...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  numberCell: { width: 38, height: 44, margin: 3, borderRadius: 6, backgroundColor: colors.card, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: colors.border },
  ...
  playerRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, padding: 12, borderRadius: 12, marginBottom: 8 },
  ...
  modal: { backgroundColor: colors.card, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, maxHeight: '80%' },
  ...
  modalLabel: { fontSize: 13, color: colors.textMuted, marginBottom: 8, marginTop: 16 },
