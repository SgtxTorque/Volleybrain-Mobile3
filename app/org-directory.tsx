...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.card, borderRadius: 12, margin: 16, paddingHorizontal: 14, gap: 10 },
  ...
  orgCard: { backgroundColor: colors.card, borderRadius: 14, padding: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center', gap: 12 },
  ...
  infoCard: { backgroundColor: colors.card, borderRadius: 16, padding: 16, gap: 14 },
