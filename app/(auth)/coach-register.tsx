...
const createStyles = (colors: any) => StyleSheet.create({
  ...
  pendingNotice: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, backgroundColor: colors.info + '15', padding: 16, borderRadius: 12, marginTop: 16 },
  pendingNoticeText: { flex: 1, fontSize: 14, color: colors.info, lineHeight: 20 },
  successNotice: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, backgroundColor: colors.success + '15', padding: 16, borderRadius: 12, marginTop: 16 },
  successNoticeText: { flex: 1, fontSize: 14, color: colors.success, lineHeight: 20 },
  footer: { padding: 16, borderTopWidth: 1, borderTopColor: colors.border },
  submitBtn: { backgroundColor: colors.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 16, borderRadius: 12, gap: 8 },
